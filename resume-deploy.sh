...
system "solana program deploy --buffer ./target/recover.json --upgrade-authority /home/alwin/.config/solana/id.json --program-id target/deploy/morpho_clone-keypair.json target/deploy/morpho_clone.so --with-compute-unit-price 100000"
